...
namespace StringCalculator
{
    public class StringCalculator
    {
        ...
        {
            const int customDelimiterTagLength = 3;
            var numberPatternRegex = new Regex(@"\d+");
            var indexOfFirstNumberMatch = numberPatternRegex.Match(numbers).Index;
            var delimiters = numbers.Substring(2, indexOfFirstNumberMatch - customDelimiterTagLength);
            return delimiters;
        }
